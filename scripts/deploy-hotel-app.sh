...
# Script de Deploy do Hotel App
# Este script faz o deploy apenas do Hotel App para a branch deploy/hotel-app

set -e

echo "🚀 Iniciando deploy do Hotel App..."
...
echo "🔄 Fazendo checkout da branch deploy/hotel-app..."
git checkout deploy/hotel-app

# Fazer merge da master na branch de deploy
echo "🔀 Fazendo merge da master na deploy/hotel-app..."
git merge master

# Enviar para o repositório
echo "📤 Enviando para o repositório..."
git push origin deploy/hotel-app

# Voltar para a branch master
echo "↩️ Voltando para a branch master..."
git checkout master

echo "✅ Deploy do Hotel App concluído com sucesso!"
