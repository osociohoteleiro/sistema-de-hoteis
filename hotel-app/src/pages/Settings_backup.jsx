...
const Settings = () => {
  ...
  const [appConfigurations, setAppConfigurations] = useState({
    'hotel-app': { app_title: '', logo_url: '', shared_from_app: null },
    'pms': { app_title: '', logo_url: '', shared_from_app: null },
    'automacao': { app_title: '', logo_url: '', shared_from_app: null },
    'site-hoteleiro': { app_title: '', logo_url: '', shared_from_app: null }
  });
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.configurations) {
          // Converter configurações da API para o formato do estado
  ...
  const saveAppConfiguration = async (appName, configData) => {
