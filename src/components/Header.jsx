...
const Header = () => {
  ...
  return (
    <header className="bg-white/10 backdrop-blur-sm border-b border-white/10 px-6 py-4 relative overflow-visible">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            {/* User Menu Dropdown */}
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-sidebar-800 rounded-lg shadow-lg border border-white/10 z-[9999]">
                <div className="py-2">
