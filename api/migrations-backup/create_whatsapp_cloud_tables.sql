-- Migration: Criar tabelas para WhatsApp Cloud API
-- Data: 2025-09-04
...
CREATE TABLE IF NOT EXISTS whatsapp_messages (
    ...
    timestamp BIGINT DEFAULT 0, -- timestamp do WhatsApp
    read_at TIMESTAMP NULL,
    internal_message_id VARCHAR(100), -- ID interno para rastreamento
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT IGNORE INTO whatsapp_quick_replies (workspace_uuid, shortcut, message, category) VALUES
('default', '/ola', 'Olá! Como posso ajudá-lo hoje?', 'saudacao'),
('default', '/obrigado', 'Obrigado pelo contato! Tenha um ótimo dia!', 'despedida'),
('default', '/aguarde', 'Por favor, aguarde um momento enquanto verifico isso para você.', 'atendimento'),
('default', '/horario', 'Nosso horário de atendimento é de segunda a sexta, das 8h às 18h.', 'informacao'),
('default', '/transferir', 'Vou transferir você para um especialista que poderá ajudá-lo melhor.', 'atendimento');

-- Adicionar variáveis de ambiente necessárias no .env
-- WHATSAPP_WEBHOOK_VERIFY_TOKEN=OSH_WEBHOOK_TOKEN_2024
